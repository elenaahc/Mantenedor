...
Imports System.IO
Imports System.Data
Public Class ComprasFecha
    Private Sub btn_buscar_Click(sender As Object, e As EventArgs) Handles btn_buscar.Click
        Dim cnn As New SqlConnection("Server = DESKTOP-HKI745B; Database = Mantenedor; Integrated Security = True ")
        Dim cmd As SqlCommand
        cmd = New SqlCommand()
        cmd.Connection = cnn
        cmd.CommandText = "SELECT id_com as IDCompra, rut_prov as RutProveedor, n_fac_com as NFactura,fec_com as Fecha, obs_com as Observación, val_com as Valor, por_iva_com as ValorIVA FROM Compra WHERE (fec_com = @fec_com)"
    ...
    Public Sub ExportarDatosPDF(ByVal document As Document)
        ...
        Dim encabezado As New Paragraph("Reporte de Compras por fecha solicitada", New Font(Font.Name = "Tahoma", 20, Font.Bold))
    ...
    Private Sub reporte_btn_Click(sender As Object, e As EventArgs) Handles reporte_btn.Click
        Try
            ...
            Dim filename As String = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\Compras Por Fecha.pdf"
